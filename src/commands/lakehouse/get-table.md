...
## Purpose
Get detailed information about a lakehouse table.
...
if [ "$http_code" = "200" ]; then
  ...
  echo ""
  echo "💡 Next steps:"
  echo "  • Get schema: /fabric:get-table-schema $workspace_id $lakehouse_id $table_name"
  echo "  • Query data: /fabric:query-lakehouse $workspace_id $lakehouse_id \"SELECT * FROM $table_name LIMIT 10\""
else
...
## API Reference
- **Endpoint**: `GET .../lakehouses/{id}/tables/{tableName}`
- **Response**: 200 OK
